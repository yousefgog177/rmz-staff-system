...
module.exports.execute = (heart, app, ws) => {
    ...
    var files = fs.readdirSync(path.join(__dirname, "subscriptions")).filter(filename => filename.endsWith(".js"));
    for (var filename of files) {
        var request = require(`./subscriptions/${filename}`);
    ...
    console.log("[ROUTES] subscriptions is loaded!")
