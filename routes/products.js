...
module.exports.execute = (heart, app, ws) => {
    ...
    var files = fs.readdirSync(path.join(__dirname, "products")).filter(filename => filename.endsWith(".js"));
    for (var filename of files) {
        var request = require(`./products/${filename}`);
    ...
    console.log("[ROUTES] products is loaded!")
