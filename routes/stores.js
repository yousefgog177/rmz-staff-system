...
module.exports.execute = (heart, app, ws) => {
    ...
    var files = fs.readdirSync(path.join(__dirname, "stores")).filter(filename => filename.endsWith(".js"));
    for (var filename of files) {
        var request = require(`./stores/${filename}`);
    ...
    console.log("[ROUTES] stores is loaded!")
