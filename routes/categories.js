...
module.exports.execute = (heart, app, ws) => {
    ...
    var files = fs.readdirSync(path.join(__dirname, "categories")).filter(filename => filename.endsWith(".js"));
    for (var filename of files) {
        var request = require(`./categories/${filename}`);
    ...
    console.log("[ROUTES] categories is loaded!")
