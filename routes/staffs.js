...
module.exports.execute = (heart, app, ws) => {
    ...
    var files = fs.readdirSync(path.join(__dirname, "staffs")).filter(filename => filename.endsWith(".js"));
    for (var filename of files) {
        var request = require(`./staffs/${filename}`);
    ...
    console.log("[ROUTES] staffs is loaded!")
